...
public final class EngineOutputTags {
    ...
    public static final OutputTag<DecisionLogRecord> DECISION_LOG = new OutputTag<>("decision-log", EngineTypeInfos.decisionLogRecord()) {
    };

    public static final OutputTag<EngineErrorRecord> ENGINE_ERROR = new OutputTag<>("engine-error", EngineTypeInfos.engineErrorRecord()) {
    };
