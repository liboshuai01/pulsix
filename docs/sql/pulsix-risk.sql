...
INSERT INTO `event_schema` (`id`, `scene_code`, `event_code`, `event_name`, `version`, `status`, `description`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(1, 'PROMOTION_RISK', 'PROMOTION_EVENT', '营销受理事件', 1, 1, '营销受理标准事件模型', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(2, 'WITHDRAW_RISK', 'WITHDRAW_EVENT', '提现申请事件', 1, 1, '提现申请标准事件模型', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(3, 'ORDER_RISK', 'ORDER_EVENT', '支付成功事件', 1, 1, '订单支付成功标准事件模型', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0');

INSERT INTO `event_field_def` (`id`, `event_code`, `field_name`, `field_label`, `field_type`, `required_flag`, `default_value`, `sample_value`, `description`, `sort_no`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(101, 'PROMOTION_EVENT', 'eventId', '事件ID', 'STRING', 1, NULL, 'E_PROMO_0001', '事件唯一标识', 1, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(102, 'PROMOTION_EVENT', 'traceId', '链路ID', 'STRING', 1, NULL, 'T_PROMO_0001', '全链路追踪号', 2, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(103, 'PROMOTION_EVENT', 'sceneCode', '场景编码', 'STRING', 1, 'PROMOTION_RISK', 'PROMOTION_RISK', '场景编码', 3, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(104, 'PROMOTION_EVENT', 'eventCode', '事件编码', 'STRING', 1, 'PROMOTION_EVENT', 'PROMOTION_EVENT', '事件编码', 4, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(105, 'PROMOTION_EVENT', 'eventTime', '事件时间', 'DATETIME', 1, NULL, '2026-03-08T10:00:00', '事件发生时间', 5, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(106, 'PROMOTION_EVENT', 'userId', '用户ID', 'STRING', 1, NULL, 'U20001', '用户主键', 6, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(107, 'PROMOTION_EVENT', 'deviceId', '设备ID', 'STRING', 1, NULL, 'DVC_PROMO_001', '设备主键', 7, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(108, 'PROMOTION_EVENT', 'ip', 'IP', 'STRING', 1, NULL, '203.0.113.10', '客户端 IP', 8, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(109, 'PROMOTION_EVENT', 'channel', '渠道', 'STRING', 1, 'APP', 'APP', '请求渠道', 9, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(110, 'PROMOTION_EVENT', 'bizNo', '业务请求号', 'STRING', 1, NULL, 'PROMO_REQ_202603080001', '营销业务请求号', 10, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(111, 'PROMOTION_EVENT', 'activityId', '活动ID', 'STRING', 1, NULL, 'ACT_INVITE_202603', '营销活动编号', 11, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(112, 'PROMOTION_EVENT', 'promotionType', '营销类型', 'STRING', 1, NULL, 'INVITE_REWARD', '营销受理类型', 12, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(113, 'PROMOTION_EVENT', 'rewardType', '奖励类型', 'STRING', 1, NULL, 'COUPON', '奖励介质类型', 13, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(114, 'PROMOTION_EVENT', 'rewardValue', '奖励面额', 'DECIMAL', 1, NULL, '30', '本次发放奖励面额', 14, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(115, 'PROMOTION_EVENT', 'grantStatus', '受理状态', 'STRING', 1, NULL, 'ACCEPTED', '营销动作受理状态', 15, 'admin', '2026-03-08 10:01:00', 'admin', '2026-03-08 10:01:00', b'0'),
(201, 'WITHDRAW_EVENT', 'eventId', '事件ID', 'STRING', 1, NULL, 'E_WD_0001', '事件唯一标识', 1, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(202, 'WITHDRAW_EVENT', 'traceId', '链路ID', 'STRING', 1, NULL, 'T_WD_0001', '全链路追踪号', 2, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(203, 'WITHDRAW_EVENT', 'sceneCode', '场景编码', 'STRING', 1, 'WITHDRAW_RISK', 'WITHDRAW_RISK', '场景编码', 3, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(204, 'WITHDRAW_EVENT', 'eventCode', '事件编码', 'STRING', 1, 'WITHDRAW_EVENT', 'WITHDRAW_EVENT', '事件编码', 4, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(205, 'WITHDRAW_EVENT', 'eventTime', '事件时间', 'DATETIME', 1, NULL, '2026-03-08T11:00:00', '事件发生时间', 5, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(206, 'WITHDRAW_EVENT', 'userId', '用户ID', 'STRING', 1, NULL, 'U30001', '用户主键', 6, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(207, 'WITHDRAW_EVENT', 'deviceId', '设备ID', 'STRING', 1, NULL, 'DVC_WD_001', '设备主键', 7, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(208, 'WITHDRAW_EVENT', 'ip', 'IP', 'STRING', 1, NULL, '198.51.100.21', '客户端 IP', 8, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(209, 'WITHDRAW_EVENT', 'channel', '渠道', 'STRING', 1, 'APP', 'APP', '请求渠道', 9, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(210, 'WITHDRAW_EVENT', 'bizNo', '业务请求号', 'STRING', 1, NULL, 'WD_REQ_202603080001', '提现业务请求号', 10, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(211, 'WITHDRAW_EVENT', 'withdrawNo', '提现单号', 'STRING', 1, NULL, 'WD202603080001', '提现申请单号', 11, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(212, 'WITHDRAW_EVENT', 'withdrawAmount', '提现金额', 'DECIMAL', 1, NULL, '3500', '本次提现金额', 12, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(213, 'WITHDRAW_EVENT', 'currency', '币种', 'STRING', 1, 'CNY', 'CNY', '币种', 13, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(214, 'WITHDRAW_EVENT', 'withdrawAccountId', '提现账户ID', 'STRING', 1, NULL, 'WACC_88001', '提现账户主键', 14, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(215, 'WITHDRAW_EVENT', 'accountType', '账户类型', 'STRING', 1, NULL, 'BANK_CARD', '提现账户类型', 15, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(216, 'WITHDRAW_EVENT', 'bankCode', '银行编码', 'STRING', 1, NULL, 'ICBC', '收款银行编码', 16, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(217, 'WITHDRAW_EVENT', 'withdrawStatus', '提现状态', 'STRING', 1, NULL, 'CREATED', '提现申请当前状态', 17, 'admin', '2026-03-08 11:01:00', 'admin', '2026-03-08 11:01:00', b'0'),
(301, 'ORDER_EVENT', 'eventId', '事件ID', 'STRING', 1, NULL, 'E_ORDER_0001', '事件唯一标识', 1, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(302, 'ORDER_EVENT', 'traceId', '链路ID', 'STRING', 1, NULL, 'T_ORDER_0001', '全链路追踪号', 2, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(303, 'ORDER_EVENT', 'sceneCode', '场景编码', 'STRING', 1, 'ORDER_RISK', 'ORDER_RISK', '场景编码', 3, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(304, 'ORDER_EVENT', 'eventCode', '事件编码', 'STRING', 1, 'ORDER_EVENT', 'ORDER_EVENT', '事件编码', 4, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(305, 'ORDER_EVENT', 'eventTime', '事件时间', 'DATETIME', 1, NULL, '2026-03-08T12:00:00', '事件发生时间', 5, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(306, 'ORDER_EVENT', 'userId', '用户ID', 'STRING', 1, NULL, 'U40001', '用户主键', 6, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(307, 'ORDER_EVENT', 'deviceId', '设备ID', 'STRING', 1, NULL, 'DVC_ORDER_001', '设备主键', 7, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(308, 'ORDER_EVENT', 'ip', 'IP', 'STRING', 1, NULL, '192.0.2.18', '客户端 IP', 8, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(309, 'ORDER_EVENT', 'channel', '渠道', 'STRING', 1, 'APP', 'APP', '请求渠道', 9, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(310, 'ORDER_EVENT', 'bizNo', '业务请求号', 'STRING', 1, NULL, 'ORD202603080001', '订单业务号', 10, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(311, 'ORDER_EVENT', 'orderNo', '订单号', 'STRING', 1, NULL, 'ORD202603080001', '订单主键', 11, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(312, 'ORDER_EVENT', 'orderAmount', '订单金额', 'DECIMAL', 1, NULL, '1299', '订单应付金额', 12, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(313, 'ORDER_EVENT', 'payAmount', '实付金额', 'DECIMAL', 1, NULL, '1299', '订单实付金额', 13, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(314, 'ORDER_EVENT', 'currency', '币种', 'STRING', 1, 'CNY', 'CNY', '币种', 14, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(315, 'ORDER_EVENT', 'merchantId', '商户ID', 'STRING', 1, NULL, 'MCH_3001', '商户编号', 15, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(316, 'ORDER_EVENT', 'fulfillmentType', '履约方式', 'STRING', 1, NULL, 'EXPRESS', '履约方式', 16, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0'),
(317, 'ORDER_EVENT', 'orderStatus', '订单状态', 'STRING', 1, NULL, 'PAID', '订单当前状态', 17, 'admin', '2026-03-08 12:01:00', 'admin', '2026-03-08 12:01:00', b'0');
...
INSERT INTO `feature_stream_conf` (`id`, `scene_code`, `feature_code`, `source_event_codes`, `entity_key_expr`, `agg_type`, `value_expr`, `filter_expr`, `window_type`, `window_size`, `window_slide`, `include_current_event`, `ttl_seconds`, `state_hint_json`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(2001, 'PROMOTION_RISK', 'ip_promo_cnt_10m', 'PROMOTION_EVENT', 'ip', 'COUNT', '1', 'grantStatus == ''ACCEPTED''', 'SLIDING', '10m', '1m', 1, 1800, '{"keyBy":"ip"}', 'admin', '2026-03-08 10:12:00', 'admin', '2026-03-08 10:12:00', b'0'),
(2002, 'PROMOTION_RISK', 'device_promo_user_cnt_1h', 'PROMOTION_EVENT', 'deviceId', 'DISTINCT_COUNT', 'userId', 'grantStatus == ''ACCEPTED'' && deviceId != null && userId != null', 'SLIDING', '1h', '5m', 1, 7200, '{"keyBy":"deviceId"}', 'admin', '2026-03-08 10:12:00', 'admin', '2026-03-08 10:12:00', b'0'),
(2101, 'WITHDRAW_RISK', 'user_withdraw_cnt_24h', 'WITHDRAW_EVENT', 'userId', 'COUNT', '1', '(withdrawStatus == ''CREATED'' || withdrawStatus == ''PENDING_REVIEW'') && userId != null', 'SLIDING', '24h', '30m', 1, 172800, '{"keyBy":"userId"}', 'admin', '2026-03-08 11:12:00', 'admin', '2026-03-08 11:12:00', b'0'),
(2102, 'WITHDRAW_RISK', 'device_withdraw_user_cnt_24h', 'WITHDRAW_EVENT', 'deviceId', 'DISTINCT_COUNT', 'userId', '(withdrawStatus == ''CREATED'' || withdrawStatus == ''PENDING_REVIEW'') && deviceId != null && userId != null', 'SLIDING', '24h', '30m', 1, 172800, '{"keyBy":"deviceId"}', 'admin', '2026-03-08 11:12:00', 'admin', '2026-03-08 11:12:00', b'0');
...
(14201, 14101, 'reqNo', '原始请求号', 'reqNo', 'STRING', 1, 'PROMO_REQ_202603180001', '旧协议请求号，兼作 eventId 与 bizNo', 10, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14202, 14101, 'applyAt', '受理时间', 'applyAt', 'STRING', 1, '2026-03-18 09:30:21', '旧协议时间字符串，需按指定格式转为标准时间', 20, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14203, 14101, 'actorUid', '用户ID', 'actor.uid', 'STRING', 1, 'U20001', '嵌套结构中的用户主键', 30, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14204, 14101, 'actorDid', '设备ID', 'actor.did', 'STRING', 0, 'DVC_PROMO_99', '嵌套结构中的设备主键', 40, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14205, 14101, 'actorIp', '客户端IP', 'actor.ip', 'STRING', 0, '203.0.113.10', '嵌套结构中的客户端 IP', 50, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14206, 14101, 'actId', '活动ID', 'actId', 'STRING', 1, 'ACT_INVITE_202603', '营销活动编号', 60, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14207, 14101, 'bizType', '业务类型', 'bizType', 'STRING', 1, 'INVITE', '需归一为标准 promotionType', 70, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14208, 14101, 'rewardKind', '奖励介质', 'reward.kind', 'STRING', 1, 'VOUCHER', '需归一为标准 rewardType', 80, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14209, 14101, 'rewardFaceValueCent', '奖励面额(分)', 'reward.faceValueCent', 'INTEGER', 1, '3000', '需换算为标准 rewardValue（元）', 90, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14210, 14101, 'result', '受理结果', 'result', 'STRING', 1, 'OK', '需归一为标准 grantStatus', 100, 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14221, 14102, 'reqId', '原始请求号', 'reqId', 'STRING', 1, 'WD_APPLY_202603180001', '旧协议请求号，兼作 eventId 与 bizNo', 10, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14222, 14102, 'occurredAt', '申请时间', 'occurredAt', 'STRING', 1, '2026/03/18 11:02:45', '旧协议时间字符串，需按 yyyy/MM/dd HH:mm:ss 转换', 20, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14223, 14102, 'uid', '用户ID', 'uid', 'STRING', 1, 'U30123', '提现申请用户主键', 30, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14224, 14102, 'clientDeviceNo', '设备号', 'client.deviceNo', 'STRING', 0, 'DVC_WD_7788', '嵌套结构中的设备号', 40, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14225, 14102, 'clientIpAddr', '客户端IP', 'client.ipAddr', 'STRING', 0, '10.40.2.11', '嵌套结构中的客户端 IP', 50, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14226, 14102, 'withdrawOrderId', '提现单号', 'withdrawOrderId', 'STRING', 1, 'WD202603180001', '提现业务单号', 60, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14227, 14102, 'amountFen', '提现金额(分)', 'amountFen', 'LONG', 1, '520000', '需换算为标准 withdrawAmount（元）', 70, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14228, 14102, 'accountId', '提现账户ID', 'account.id', 'STRING', 1, 'WACC_88001', '嵌套结构中的提现账户主键', 80, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14229, 14102, 'accountTypeCode', '账户类型编码', 'account.type', 'INTEGER', 1, '2', '需归一为标准 accountType', 90, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14230, 14102, 'bankCode', '银行编码', 'account.bank', 'STRING', 0, 'ICBC', '原始银行编码', 100, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14231, 14102, 'status', '提现状态码', 'status', 'INTEGER', 1, '0', '需归一为标准 withdrawStatus', 110, 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14241, 14103, 'payOrderId', '支付单号', 'payOrderId', 'STRING', 1, 'ORD202603180001', '旧 SDK 协议中的支付单号，兼作 eventId / bizNo / orderNo', 10, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14242, 14103, 'uid', '用户ID', 'uid', 'STRING', 1, 'U50001', '订单支付用户主键', 20, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14243, 14103, 'device', '设备ID', 'device', 'STRING', 0, 'D40001', '旧 SDK 协议中的设备字段', 30, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14244, 14103, 'tradeAmount', '订单金额(分)', 'tradeAmount', 'LONG', 1, '19990', '需换算为标准 orderAmount / payAmount（元）', 40, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14245, 14103, 'payState', '支付状态', 'payState', 'STRING', 1, '1', '需归一为标准 orderStatus', 50, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14246, 14103, 'paidAt', '支付时间', 'paidAt', 'STRING', 1, '20260318120530', '旧 SDK 时间格式，需按 yyyyMMddHHmmss 转换', 60, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14247, 14103, 'merchantNo', '商户编号', 'merchantNo', 'STRING', 1, 'MCH_3001', '旧 SDK 协议中的商户字段', 70, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14248, 14103, 'fulfillment', '履约方式', 'fulfillment', 'STRING', 1, 'express', '需归一为标准 fulfillmentType', 80, 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0');
...
(14301, 14101, 'eventId', 'SOURCE_FIELD', 'reqNo', NULL, NULL, NULL, NULL, NULL, '原始请求号直出为事件ID', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14302, 14101, 'traceId', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Trace-Id'']', NULL, NULL, '从请求头提取 traceId', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14303, 14101, 'sceneCode', 'CONSTANT', NULL, 'PROMOTION_RISK', NULL, NULL, NULL, NULL, '锁定营销场景编码', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14304, 14101, 'eventCode', 'CONSTANT', NULL, 'PROMOTION_EVENT', NULL, NULL, NULL, NULL, '锁定营销事件编码', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14305, 14101, 'eventTime', 'SOURCE_FIELD', 'applyAt', NULL, NULL, NULL, 'yyyy-MM-dd HH:mm:ss', NULL, '旧协议时间字符串转换为标准事件时间', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14306, 14101, 'userId', 'SOURCE_FIELD', 'actor.uid', NULL, NULL, NULL, NULL, NULL, '映射嵌套用户ID', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14307, 14101, 'deviceId', 'SOURCE_FIELD', 'actor.did', NULL, NULL, NULL, NULL, NULL, '映射嵌套设备ID', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14308, 14101, 'ip', 'SOURCE_FIELD', 'actor.ip', NULL, NULL, NULL, NULL, NULL, '映射嵌套客户端 IP', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14309, 14101, 'channel', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Channel'']', NULL, NULL, '从请求头补齐渠道字段', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14310, 14101, 'bizNo', 'SOURCE_FIELD', 'reqNo', NULL, NULL, NULL, NULL, NULL, '原始请求号直出为业务请求号', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14311, 14101, 'activityId', 'SOURCE_FIELD', 'actId', NULL, NULL, NULL, NULL, NULL, '映射活动ID', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14312, 14101, 'promotionType', 'SOURCE_FIELD', 'bizType', NULL, NULL, NULL, NULL, '{"INVITE":"INVITE_REWARD","FLASH_SALE":"FLASH_SALE","COUPON":"COUPON"}', '将旧协议业务类型归一为标准 promotionType', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14313, 14101, 'rewardType', 'SOURCE_FIELD', 'reward.kind', NULL, NULL, NULL, NULL, '{"VOUCHER":"COUPON","POINTS":"POINT","CASH":"CASH"}', '将旧协议奖励介质归一为标准 rewardType', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14314, 14101, 'rewardValue', 'SCRIPT', NULL, NULL, 'AVIATOR', 'rawPayload[''reward''][''faceValueCent''] / 100.0', NULL, NULL, '将奖励面额从分换算为元', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14315, 14101, 'grantStatus', 'SOURCE_FIELD', 'result', NULL, NULL, NULL, NULL, '{"OK":"ACCEPTED","REJECT":"REJECTED","FREEZE":"FROZEN"}', '将旧协议受理结果归一为标准 grantStatus', 'admin', '2026-03-08 10:00:00', 'admin', '2026-03-08 10:00:00', b'0'),
(14321, 14102, 'eventId', 'SOURCE_FIELD', 'reqId', NULL, NULL, NULL, NULL, NULL, '原始请求号直出为事件ID', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14322, 14102, 'traceId', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Trace-Id'']', NULL, NULL, '从请求头提取 traceId', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14323, 14102, 'sceneCode', 'CONSTANT', NULL, 'WITHDRAW_RISK', NULL, NULL, NULL, NULL, '锁定提现场景编码', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14324, 14102, 'eventCode', 'CONSTANT', NULL, 'WITHDRAW_EVENT', NULL, NULL, NULL, NULL, '锁定提现事件编码', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14325, 14102, 'eventTime', 'SOURCE_FIELD', 'occurredAt', NULL, NULL, NULL, 'yyyy/MM/dd HH:mm:ss', NULL, '将旧协议申请时间转换为标准事件时间', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14326, 14102, 'userId', 'SOURCE_FIELD', 'uid', NULL, NULL, NULL, NULL, NULL, '映射用户ID', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14327, 14102, 'deviceId', 'SOURCE_FIELD', 'client.deviceNo', NULL, NULL, NULL, NULL, NULL, '映射嵌套设备号', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14328, 14102, 'ip', 'SOURCE_FIELD', 'client.ipAddr', NULL, NULL, NULL, NULL, NULL, '映射嵌套客户端 IP', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14329, 14102, 'channel', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Channel'']', NULL, NULL, '从请求头补齐渠道字段', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14330, 14102, 'bizNo', 'SOURCE_FIELD', 'reqId', NULL, NULL, NULL, NULL, NULL, '原始请求号直出为业务请求号', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14331, 14102, 'withdrawNo', 'SOURCE_FIELD', 'withdrawOrderId', NULL, NULL, NULL, NULL, NULL, '映射提现单号', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14332, 14102, 'withdrawAmount', 'SCRIPT', NULL, NULL, 'AVIATOR', 'rawPayload[''amountFen''] / 100.0', NULL, NULL, '将提现金额从分换算为元', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14333, 14102, 'currency', 'CONSTANT', NULL, 'CNY', NULL, NULL, NULL, NULL, '补齐标准币种', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14334, 14102, 'withdrawAccountId', 'SOURCE_FIELD', 'account.id', NULL, NULL, NULL, NULL, NULL, '映射嵌套提现账户ID', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14335, 14102, 'accountType', 'SOURCE_FIELD', 'account.type', NULL, NULL, NULL, NULL, '{"1":"ALIPAY","2":"BANK_CARD","3":"WECHAT"}', '将账户类型编码归一为标准 accountType', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14336, 14102, 'bankCode', 'SOURCE_FIELD', 'account.bank', NULL, NULL, NULL, NULL, NULL, '映射原始银行编码', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14337, 14102, 'withdrawStatus', 'SOURCE_FIELD', 'status', NULL, NULL, NULL, NULL, '{"0":"CREATED","1":"PROCESSING","2":"SUCCESS","3":"FAILED"}', '将状态码归一为标准 withdrawStatus', 'admin', '2026-03-08 11:00:00', 'admin', '2026-03-08 11:00:00', b'0'),
(14341, 14103, 'eventId', 'SOURCE_FIELD', 'payOrderId', NULL, NULL, NULL, NULL, NULL, '支付单号直出为事件ID', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14342, 14103, 'traceId', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Trace-Id'']', NULL, NULL, '从 SDK 请求头提取 traceId', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14343, 14103, 'sceneCode', 'CONSTANT', NULL, 'ORDER_RISK', NULL, NULL, NULL, NULL, '锁定订单场景编码', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14344, 14103, 'eventCode', 'CONSTANT', NULL, 'ORDER_EVENT', NULL, NULL, NULL, NULL, '锁定订单事件编码', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14345, 14103, 'eventTime', 'SOURCE_FIELD', 'paidAt', NULL, NULL, NULL, 'yyyyMMddHHmmss', NULL, '将旧 SDK 时间字符串转换为标准事件时间', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14346, 14103, 'userId', 'SOURCE_FIELD', 'uid', NULL, NULL, NULL, NULL, NULL, '映射用户ID', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14347, 14103, 'deviceId', 'SOURCE_FIELD', 'device', NULL, NULL, NULL, NULL, NULL, '映射旧 SDK 设备字段', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14348, 14103, 'ip', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Client-Ip'']', NULL, NULL, '从 SDK 请求头补齐客户端 IP', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14349, 14103, 'channel', 'SCRIPT', NULL, NULL, 'AVIATOR', 'headers[''X-Client-Channel'']', NULL, NULL, '从 SDK 请求头补齐渠道字段', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14350, 14103, 'bizNo', 'SOURCE_FIELD', 'payOrderId', NULL, NULL, NULL, NULL, NULL, '支付单号直出为业务请求号', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14351, 14103, 'orderNo', 'SOURCE_FIELD', 'payOrderId', NULL, NULL, NULL, NULL, NULL, '支付单号复用为订单号', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14352, 14103, 'orderAmount', 'SCRIPT', NULL, NULL, 'AVIATOR', 'rawPayload[''tradeAmount''] / 100.0', NULL, NULL, '将订单金额从分换算为标准 orderAmount', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14353, 14103, 'payAmount', 'SCRIPT', NULL, NULL, 'AVIATOR', 'rawPayload[''tradeAmount''] / 100.0', NULL, NULL, '将订单金额从分换算为标准 payAmount', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14354, 14103, 'currency', 'CONSTANT', NULL, 'CNY', NULL, NULL, NULL, NULL, '补齐标准币种', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14355, 14103, 'merchantId', 'SOURCE_FIELD', 'merchantNo', NULL, NULL, NULL, NULL, NULL, '映射旧 SDK 商户字段', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14356, 14103, 'fulfillmentType', 'SOURCE_FIELD', 'fulfillment', NULL, NULL, NULL, NULL, '{"express":"EXPRESS","pickup":"SELF_PICKUP","virtual":"VIRTUAL"}', '将履约方式归一为标准 fulfillmentType', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0'),
(14357, 14103, 'orderStatus', 'SOURCE_FIELD', 'payState', NULL, NULL, NULL, NULL, '{"1":"PAID","0":"CREATED","2":"CLOSED"}', '将支付状态归一为标准 orderStatus', 'admin', '2026-03-08 12:00:00', 'admin', '2026-03-08 12:00:00', b'0');
