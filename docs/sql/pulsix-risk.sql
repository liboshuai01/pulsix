...
CREATE TABLE `policy_score_band`  (
  ...
  `enabled_flag` tinyint NOT NULL DEFAULT 0 COMMENT '是否启用：0-启用，1-停用',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `ingest_source`  (
  ...
  `error_topic_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pulsix.event.dlq' COMMENT '异常 / DLQ 事件写入 Topic，默认 pulsix.event.dlq',
...
-- 3. 当前已补齐发布、仿真、决策日志、接入异常、监控、审计与回放样例数据，可直接用于管理端阶段验收。
-- ============================================================
-- ----------------------------
...
(2141, 'trade_http_demo', '交易 HTTP Demo', 'HTTP', 'HMAC', '{"headerName":"X-Pulsix-Signature","timestampHeader":"X-Pulsix-Timestamp","algorithm":"HmacSHA256","appKey":"trade-http-demo","appSecret":"trade-http-demo"}', '["TRADE_RISK"]', 'pulsix.event.standard', 'pulsix.event.dlq', 300, 0, 'S05 HTTP 接入源样例，演示 Header + HMAC 鉴权配置。', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
...
-- ----------------------------
DELETE FROM `scene_release` WHERE `scene_code` = 'TRADE_RISK' AND `version_no` IN (12, 13, 14, 15);
...
(2204, 'TRADE_RISK', 15, '{"snapshotId":"TRADE_RISK_v15","sceneCode":"TRADE_RISK","sceneName":"交易风控","version":15,"status":"DRAFT","checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d915","publishedAt":null,"effectiveFrom":null,"runtimeMode":"ASYNC_DECISION","scene":{"defaultPolicyCode":"TRADE_RISK_POLICY","allowedEventTypes":["trade"],"decisionTimeoutMs":500,"logLevel":"FULL"},"eventSchema":{"eventCode":"TRADE_EVENT","eventType":"trade","requiredFields":["eventId","sceneCode","eventType","eventTime","userId","deviceId","ip","amount","result"],"optionalFields":["merchantId","channel","province","city","ext"]},"variables":{"baseFields":["eventId","sceneCode","eventType","eventTime","traceId","userId","deviceId","ip","amount","result","merchantId","channel","province","city"]},"streamFeatures":[{"code":"user_trade_cnt_5m","name":"用户5分钟交易次数","type":"STREAM","sourceEventTypes":["trade"],"entityType":"USER","entityKeyExpr":"userId","aggType":"COUNT","valueExpr":"1","filterExpr":"result == ''SUCCESS''","windowType":"SLIDING","windowSize":"5m","windowSlide":"1m","includeCurrentEvent":true,"ttl":"10m","valueType":"LONG"},{"code":"user_trade_amt_sum_30m","name":"用户30分钟交易金额和","type":"STREAM","sourceEventTypes":["trade"],"entityType":"USER","entityKeyExpr":"userId","aggType":"SUM","valueExpr":"amount","filterExpr":"result == ''SUCCESS''","windowType":"SLIDING","windowSize":"30m","windowSlide":"1m","includeCurrentEvent":true,"ttl":"40m","valueType":"DECIMAL"},{"code":"device_bind_user_cnt_1h","name":"设备1小时关联用户数","type":"STREAM","sourceEventTypes":["trade"],"entityType":"DEVICE","entityKeyExpr":"deviceId","aggType":"DISTINCT_COUNT","valueExpr":"userId","filterExpr":"deviceId != nil && userId != nil","windowType":"SLIDING","windowSize":"1h","windowSlide":"5m","includeCurrentEvent":true,"ttl":"2h","valueType":"LONG"}],"lookupFeatures":[{"code":"device_in_blacklist","name":"设备是否命中黑名单","type":"LOOKUP","lookupType":"REDIS_SET","keyExpr":"deviceId","sourceRef":"pulsix:list:black:device","defaultValue":false,"valueType":"BOOLEAN","timeoutMs":20,"cacheTtlSeconds":30},{"code":"user_risk_level","name":"用户风险等级","type":"LOOKUP","lookupType":"REDIS_HASH","keyExpr":"userId","sourceRef":"pulsix:profile:user:risk","defaultValue":"L","valueType":"STRING","timeoutMs":20,"cacheTtlSeconds":30}],"derivedFeatures":[{"code":"high_amt_flag","name":"高金额标记","type":"DERIVED","engineType":"AVIATOR","expr":"amount >= 5000","dependsOn":["amount"],"valueType":"BOOLEAN"},{"code":"trade_burst_flag","name":"短时高频交易标记","type":"DERIVED","engineType":"AVIATOR","expr":"user_trade_cnt_5m >= 3 && amount >= 5000","dependsOn":["user_trade_cnt_5m","amount"],"valueType":"BOOLEAN"}],"rules":[{"code":"R001","name":"黑名单设备直接拒绝","engineType":"AVIATOR","priority":100,"whenExpr":"device_in_blacklist == true","dependsOn":["device_in_blacklist"],"hitAction":"REJECT","riskScore":100,"hitReasonTemplate":"设备命中黑名单","enabled":true},{"code":"R002","name":"大额且短时高频交易","engineType":"AVIATOR","priority":90,"whenExpr":"amount >= 5000","dependsOn":["amount"],"hitAction":"REVIEW","riskScore":60,"hitReasonTemplate":"当前金额={amount}，建议人工复核","enabled":true},{"code":"R003","name":"高风险用户多账号设备","engineType":"GROOVY","priority":80,"whenExpr":"return device_bind_user_cnt_1h >= 4 && [''M'',''H''].contains(user_risk_level)","dependsOn":["device_bind_user_cnt_1h","user_risk_level"],"hitAction":"REJECT","riskScore":80,"hitReasonTemplate":"设备1小时关联用户数={device_bind_user_cnt_1h}, 用户风险等级={user_risk_level}","enabled":true}],"policy":{"policyCode":"TRADE_RISK_POLICY","policyName":"交易风控主策略","decisionMode":"FIRST_HIT","defaultAction":"PASS","ruleOrder":["R001","R003","R002"]},"runtimeHints":{"requiredStreamFeatures":["user_trade_cnt_5m","user_trade_amt_sum_30m","device_bind_user_cnt_1h"],"requiredLookupFeatures":["device_in_blacklist","user_risk_level"],"requiredDerivedFeatures":["high_amt_flag","trade_burst_flag"],"maxRuleExecutionCount":100,"allowGroovy":true,"needFullDecisionLog":true}}', '8d2041a7cf8f47b4b6b0f91d2ab8d915', 'DRAFT', 'PASSED', '{"checks":[{"type":"SNAPSHOT","result":"PASS","message":"S21 回放候选版本：已将 R002 调整为按金额直接复核"}],"warnings":[]}', '{"streamFeatures":["user_trade_cnt_5m","user_trade_amt_sum_30m","device_bind_user_cnt_1h"],"lookupFeatures":["device_in_blacklist","user_risk_level"],"derivedFeatures":["high_amt_flag","trade_burst_flag"],"rules":["R001","R002","R003"]}', NULL, 7, 3, 1, NULL, NULL, NULL, NULL, 'S21 回放候选版本样例：将 R002 调整为按金额直接复核，用于与 v14 做差异回放。', 'admin', '2026-03-12 11:00:00', 'admin', '2026-03-12 11:00:00', b'0');



-- ----------------------------
-- Records of simulation_case / simulation_report
-- ----------------------------
DELETE FROM `simulation_report` WHERE `id` IN (6101, 6102) OR `case_id` IN (5101, 5102);
DELETE FROM `simulation_case` WHERE `scene_code` = 'TRADE_RISK' AND `case_code` IN ('SIM_REJECT_BLACKLIST', 'SIM_REVIEW_BURST');
...
(5101, 'TRADE_RISK', 'SIM_REJECT_BLACKLIST', '黑名单设备直接拒绝', 'LATEST', NULL, '{"eventId":"E_SIM_5101","traceId":"TRACE-S15-5101","eventTime":"2026-03-12T10:00:00","eventType":"trade","userId":"U9101","deviceId":"D-BLACK-001","ip":"66.77.88.99","amount":6800,"result":"SUCCESS"}', '{"user_trade_cnt_5m":0}', '{"device_in_blacklist":true}', 'REJECT', JSON_ARRAY('R001'), 0, 'S15 仿真样例：通过 mock lookup 命中黑名单规则，验证最新已发布版本的直接拒绝链路。', 'admin', '2026-03-12 10:00:00', 'admin', '2026-03-12 10:00:00', b'0'),
(5102, 'TRADE_RISK', 'SIM_REVIEW_BURST', '大额且短时高频交易复核', 'FIXED', 12, '{"eventId":"E_SIM_5102","eventTime":"2026-03-12T10:05:00","userId":"U9102","deviceId":"D-NORMAL-002","ip":"10.20.30.40","amount":6800,"result":"SUCCESS"}', '{"user_trade_cnt_5m":3}', '{"device_in_blacklist":false,"user_risk_level":"L"}', 'REVIEW', JSON_ARRAY('R002'), 0, 'S15 仿真样例：固定使用 v12，通过 mock stream feature 命中高频大额复核规则。', 'admin', '2026-03-12 10:05:00', 'admin', '2026-03-12 10:05:00', b'0');
...
(6101, 5101, 'TRADE_RISK', 14, 'TRACE-S15-5101', '{"snapshotId":"TRADE_RISK_v14","sceneCode":"TRADE_RISK","version":14,"usedVersion":14,"checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d914","eventCount":1,"overridesApplied":true,"finalResult":{"eventIndex":0,"eventId":"E_SIM_5101","traceId":"TRACE-S15-5101","sceneCode":"TRADE_RISK","version":14,"usedVersion":14,"finalAction":"REJECT","finalScore":100,"totalScore":100,"reason":"设备命中黑名单","hitRules":[{"ruleCode":"R001","ruleName":"黑名单设备直接拒绝","action":"REJECT","score":100,"reason":"设备命中黑名单","detail":{"device_in_blacklist":"true"}}],"hitReasons":["设备命中黑名单"],"featureSnapshot":{"amount":"6800","device_in_blacklist":"true","high_amt_flag":"true","trade_burst_flag":"false","user_trade_cnt_5m":"0"},"trace":["lookup:device_in_blacklist=true","derived:high_amt_flag=true","derived:trade_burst_flag=false","rule:R001=true","policy:finalAction=REJECT"]},"results":[{"eventIndex":0,"eventId":"E_SIM_5101","traceId":"TRACE-S15-5101","sceneCode":"TRADE_RISK","version":14,"usedVersion":14,"finalAction":"REJECT","finalScore":100,"totalScore":100,"reason":"设备命中黑名单","hitRules":[{"ruleCode":"R001","ruleName":"黑名单设备直接拒绝","action":"REJECT","score":100,"reason":"设备命中黑名单","detail":{"device_in_blacklist":"true"}}],"hitReasons":["设备命中黑名单"],"featureSnapshot":{"amount":"6800","device_in_blacklist":"true","high_amt_flag":"true","trade_burst_flag":"false","user_trade_cnt_5m":"0"},"trace":["lookup:device_in_blacklist=true","derived:high_amt_flag=true","derived:trade_burst_flag=false","rule:R001=true","policy:finalAction=REJECT"]}]}', 1, 7, 'admin', '2026-03-12 10:01:00', 'admin', '2026-03-12 10:01:00', b'0'),
(6102, 5102, 'TRADE_RISK', 12, 'TRACE-S15-5102', '{"snapshotId":"TRADE_RISK_v12","sceneCode":"TRADE_RISK","version":12,"usedVersion":12,"checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d901","eventCount":1,"overridesApplied":true,"finalResult":{"eventIndex":0,"eventId":"E_SIM_5102","traceId":"TRACE-S15-5102","sceneCode":"TRADE_RISK","version":12,"usedVersion":12,"finalAction":"REVIEW","finalScore":60,"totalScore":60,"reason":"用户5分钟交易次数=3, 当前金额=6800","hitRules":[{"ruleCode":"R002","ruleName":"大额且短时高频交易","action":"REVIEW","score":60,"reason":"用户5分钟交易次数=3, 当前金额=6800","detail":{"trade_burst_flag":"true","user_trade_cnt_5m":"3"}}],"hitReasons":["用户5分钟交易次数=3, 当前金额=6800"],"featureSnapshot":{"amount":"6800","device_in_blacklist":"false","high_amt_flag":"true","trade_burst_flag":"true","user_trade_cnt_5m":"3","user_risk_level":"L"},"trace":["lookup:device_in_blacklist=false","stream:user_trade_cnt_5m=3","derived:high_amt_flag=true","derived:trade_burst_flag=true","rule:R002=true","policy:finalAction=REVIEW"]},"results":[{"eventIndex":0,"eventId":"E_SIM_5102","traceId":"TRACE-S15-5102","sceneCode":"TRADE_RISK","version":12,"usedVersion":12,"finalAction":"REVIEW","finalScore":60,"totalScore":60,"reason":"用户5分钟交易次数=3, 当前金额=6800","hitRules":[{"ruleCode":"R002","ruleName":"大额且短时高频交易","action":"REVIEW","score":60,"reason":"用户5分钟交易次数=3, 当前金额=6800","detail":{"trade_burst_flag":"true","user_trade_cnt_5m":"3"}}],"hitReasons":["用户5分钟交易次数=3, 当前金额=6800"],"featureSnapshot":{"amount":"6800","device_in_blacklist":"false","high_amt_flag":"true","trade_burst_flag":"true","user_trade_cnt_5m":"3","user_risk_level":"L"},"trace":["lookup:device_in_blacklist=false","stream:user_trade_cnt_5m=3","derived:high_amt_flag=true","derived:trade_burst_flag=true","rule:R002=true","policy:finalAction=REVIEW"]}]}', 1, 9, 'admin', '2026-03-12 10:06:00', 'admin', '2026-03-12 10:06:00', b'0');

-- ----------------------------
-- Records of decision_log / rule_hit_log
-- ----------------------------
DELETE FROM `rule_hit_log` WHERE `decision_id` IN (7101, 7102) OR `id` IN (7201, 7202, 7203, 7204);
DELETE FROM `decision_log` WHERE `id` IN (7101, 7102) OR `trace_id` IN ('TRACE-S16-7101', 'TRACE-S16-7102');
...
(7101, 'TRACE-S16-7101', 'E_DECISION_7101', 'TRADE_RISK', 'trade_http_demo', 'TRADE_EVENT', 'U9101', 'TRADE_RISK_POLICY', 'REJECT', 100, 14, 12, '2026-03-12 10:20:00', '{"eventId":"E_DECISION_7101","sceneCode":"TRADE_RISK","eventType":"trade","eventTime":"2026-03-12T10:20:00","traceId":"TRACE-S16-7101","userId":"U9101","deviceId":"D-BLACK-001","ip":"66.77.88.99","amount":6800,"result":"SUCCESS"}', '{"amount":6800,"device_in_blacklist":true,"high_amt_flag":true,"trade_burst_flag":false,"user_trade_cnt_5m":0}', '[{"ruleCode":"R001","ruleName":"黑名单设备直接拒绝","action":"REJECT","reason":"设备命中黑名单"}]', '{"policyMode":"FIRST_HIT","defaultAction":"PASS","finalReason":"设备命中黑名单","trace":["lookup:device_in_blacklist=true","derived:high_amt_flag=true","rule:R001=true","policy:finalAction=REJECT"]}', 'admin', '2026-03-12 10:20:02', 'admin', '2026-03-12 10:20:02', b'0'),
(7102, 'TRACE-S16-7102', 'E_DECISION_7102', 'TRADE_RISK', 'trade_http_demo', 'TRADE_EVENT', 'U9102', 'TRADE_RISK_POLICY', 'REVIEW', 60, 12, 18, '2026-03-12 10:25:00', '{"eventId":"E_DECISION_7102","sceneCode":"TRADE_RISK","eventType":"trade","eventTime":"2026-03-12T10:25:00","traceId":"TRACE-S16-7102","userId":"U9102","deviceId":"D-NORMAL-002","ip":"10.20.30.40","amount":6800,"result":"SUCCESS"}', '{"amount":6800,"device_in_blacklist":false,"high_amt_flag":true,"trade_burst_flag":true,"user_trade_cnt_5m":3,"user_risk_level":"L"}', '[{"ruleCode":"R002","ruleName":"大额且短时高频交易","action":"REVIEW","reason":"用户5分钟交易次数=3, 当前金额=6800"}]', '{"policyMode":"FIRST_HIT","defaultAction":"PASS","finalReason":"用户5分钟交易次数=3, 当前金额=6800","trace":["lookup:device_in_blacklist=false","stream:user_trade_cnt_5m=3","derived:trade_burst_flag=true","rule:R002=true","policy:finalAction=REVIEW"]}', 'admin', '2026-03-12 10:25:03', 'admin', '2026-03-12 10:25:03', b'0');
...
(7201, 7101, 'R001', '黑名单设备直接拒绝', 1, 1, '设备命中黑名单', 100, '{"device_in_blacklist":true,"deviceId":"D-BLACK-001","amount":6800}', 'admin', '2026-03-12 10:20:02', 'admin', '2026-03-12 10:20:02', b'0'),
(7202, 7102, 'R001', '黑名单设备直接拒绝', 1, 0, NULL, NULL, '{"device_in_blacklist":false}', 'admin', '2026-03-12 10:25:03', 'admin', '2026-03-12 10:25:03', b'0'),
(7203, 7102, 'R003', '高风险用户多账号设备', 2, 0, NULL, NULL, '{"device_bind_user_cnt_1h":1,"user_risk_level":"L"}', 'admin', '2026-03-12 10:25:03', 'admin', '2026-03-12 10:25:03', b'0'),
(7204, 7102, 'R002', '大额且短时高频交易', 3, 1, '用户5分钟交易次数=3, 当前金额=6800', 60, '{"trade_burst_flag":true,"user_trade_cnt_5m":3,"amount":6800}', 'admin', '2026-03-12 10:25:03', 'admin', '2026-03-12 10:25:03', b'0');

-- ----------------------------
-- Records of ingest_error_log
-- ----------------------------
DELETE FROM `ingest_error_log` WHERE `id` IN (8101, 8102, 8103) OR `trace_id` IN ('TRACE-S18-8101', 'TRACE-S18-8102', 'TRACE-S18-8103');
...
(8101, 'TRACE-S18-8101', 'trade_http_demo', 'TRADE_RISK', 'TRADE_EVENT', 'raw_trade_bad_8101', 'VALIDATE', 'REQUIRED_FIELD_MISSING', 'eventTime 缺失，且接入层无法从 occur_time_ms 中解析出合法时间', '{"event_id":"raw_trade_bad_8101","req":{"traceId":"TRACE-S18-8101"},"uid":"U8101","dev_id":"D8101","client_ip":"10.10.10.10","pay_amt":680000,"trade_result":"ok"}', '{"eventId":"raw_trade_bad_8101","traceId":"TRACE-S18-8101","sceneCode":"TRADE_RISK","eventType":"trade","userId":"U8101","deviceId":"D8101","ip":"10.10.10.10","amount":6800,"result":"SUCCESS"}', 'pulsix.event.dlq', 'PENDING', '2026-03-12 10:31:00', 1, 'admin', '2026-03-12 10:31:00', 'admin', '2026-03-12 10:31:00', b'0'),
...
DELETE FROM `risk_audit_log` WHERE `scene_code` = 'TRADE_RISK' AND `biz_type` IN ('SCENE', 'RULE', 'RELEASE');
...
(9101, 'TRACE-S20-9101', 'TRADE_RISK', 1, 'admin', 'SCENE', 'TRADE_RISK', 'UPDATE', '{"sceneCode":"TRADE_RISK","sceneName":"交易风控","status":1,"defaultPolicyCode":"TRADE_RISK_POLICY","description":"S01 场景样例：交易风控主样例。"}', '{"sceneCode":"TRADE_RISK","sceneName":"交易风控（管理端演示）","status":1,"defaultPolicyCode":"TRADE_RISK_POLICY","description":"S20 审计样例：更新场景展示名称与说明。"}', 'S20 场景修改样例：更新场景名称与说明文案。', '2026-03-12 10:40:00', 'admin', '2026-03-12 10:40:00', 'admin', '2026-03-12 10:40:00', b'0'),
(9102, 'TRACE-S20-9102', 'TRADE_RISK', 1, 'admin', 'RULE', 'R002', 'UPDATE', '{"sceneCode":"TRADE_RISK","ruleCode":"R002","ruleName":"大额且短时高频交易","priority":90,"hitAction":"REVIEW","riskScore":60,"hitReasonTemplate":"用户5分钟交易次数={user_trade_cnt_5m}, 当前金额={amount}"}', '{"sceneCode":"TRADE_RISK","ruleCode":"R002","ruleName":"大额且短时高频交易","priority":95,"hitAction":"REVIEW","riskScore":65,"hitReasonTemplate":"用户5分钟交易次数={user_trade_cnt_5m}, 当前金额={amount}，建议人工复核"}', 'S20 规则修改样例：调整优先级、分值与命中原因模板。', '2026-03-12 10:55:00', 'admin', '2026-03-12 10:55:00', 'admin', '2026-03-12 10:55:00', b'0'),
(9103, 'TRACE-S20-9103', 'TRADE_RISK', 1, 'admin', 'RELEASE', 'TRADE_RISK_v13', 'PUBLISH', '{"id":2202,"sceneCode":"TRADE_RISK","versionNo":13,"publishStatus":"DRAFT","validationStatus":"PASSED","checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d913"}', '{"id":2202,"sceneCode":"TRADE_RISK","versionNo":13,"publishStatus":"PUBLISHED","validationStatus":"PASSED","checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d913","publishedBy":"admin","publishedAt":"2026-03-12T09:00:00","effectiveFrom":"2026-03-12T09:05:00"}', 'S20 发布审计样例：正式发布版本 v13，计划于 2026-03-12 09:05:00 生效。', '2026-03-12 09:00:00', 'admin', '2026-03-12 09:00:00', 'admin', '2026-03-12 09:00:00', b'0'),
(9104, 'TRACE-S20-9104', 'TRADE_RISK', 1, 'admin', 'RELEASE', 'TRADE_RISK_v14', 'ROLLBACK', '{"id":2201,"sceneCode":"TRADE_RISK","versionNo":12,"publishStatus":"PUBLISHED","validationStatus":"PASSED","checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d901","publishedBy":"admin","publishedAt":"2026-03-07T20:00:00","effectiveFrom":"2026-03-07T20:00:10"}', '{"id":2203,"sceneCode":"TRADE_RISK","versionNo":14,"publishStatus":"ACTIVE","validationStatus":"PASSED","checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d914","publishedBy":"admin","publishedAt":"2026-03-12T09:20:00","effectiveFrom":"2026-03-12T09:20:00","rollbackFromVersion":12}', 'S20 回滚审计样例：基于历史版本 v12 生成回滚版本 v14，并立即恢复生效。', '2026-03-12 09:20:00', 'admin', '2026-03-12 09:20:00', 'admin', '2026-03-12 09:20:00', b'0');


-- ----------------------------
-- Records of replay_job
-- ----------------------------
DELETE FROM `replay_job` WHERE `scene_code` = 'TRADE_RISK' AND `job_code` IN ('REPLAY_TRADE_RISK_V14_V15', 'REPLAY_TRADE_RISK_FILE_V14_V15', 'REPLAY_TRADE_RISK_KAFKA_V14_V15');
...
(10201, 'REPLAY_TRADE_RISK_V14_V15', 'TRADE_RISK', 14, 15, 'DECISION_LOG_EXPORT', '7101,7102', 'SUCCESS', 2, 2, '{"sceneCode":"TRADE_RISK","eventCount":2,"changedEventCount":2,"changeRate":1.0,"baseline":{"snapshotId":"TRADE_RISK_v14","version":14,"checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d914","finalActionCounts":{"PASS":2},"matchedEventCount":0},"candidate":{"snapshotId":"TRADE_RISK_v15","version":15,"checksum":"8d2041a7cf8f47b4b6b0f91d2ab8d915","finalActionCounts":{"REVIEW":2},"matchedEventCount":2},"topChangeTypes":{"FINAL_ACTION":2,"FINAL_SCORE":2,"HIT_REASONS":2,"HIT_RULES":2,"TRACE":2},"sampleSize":2}', '[{"eventIndex":0,"eventId":"E_DECISION_7101","traceId":"TRACE-S16-7101","changeTypes":["FINAL_ACTION","FINAL_SCORE","HIT_RULES","HIT_REASONS","TRACE"],"baselineAction":"PASS","candidateAction":"REVIEW","baselineHitRules":[],"candidateHitRules":["R002"]},{"eventIndex":1,"eventId":"E_DECISION_7102","traceId":"TRACE-S16-7102","changeTypes":["FINAL_ACTION","FINAL_SCORE","HIT_RULES","HIT_REASONS","TRACE"],"baselineAction":"PASS","candidateAction":"REVIEW","baselineHitRules":[],"candidateHitRules":["R002"]}]', '2026-03-12 11:10:00', '2026-03-12 11:10:02', 'S21 回放样例：使用 decision_log 7101、7102 对比 v14 与候选版本 v15 的动作差异。', 'admin', '2026-03-12 11:10:00', 'admin', '2026-03-12 11:10:00', b'0'),
(10202, 'REPLAY_TRADE_RISK_FILE_V14_V15', 'TRADE_RISK', 14, 15, 'FILE', 'classpath:risk/replay/trade-risk-events.json', 'INIT', 0, 0, NULL, NULL, NULL, NULL, 'S21 文件回放样例：使用 classpath 事件文件对比 v14 与候选版本 v15。', 'admin', '2026-03-12 11:12:00', 'admin', '2026-03-12 11:12:00', b'0'),
(10203, 'REPLAY_TRADE_RISK_KAFKA_V14_V15', 'TRADE_RISK', 14, 15, 'KAFKA_EXPORT', 'classpath:risk/replay/trade-risk-kafka-export.json', 'INIT', 0, 0, NULL, NULL, NULL, NULL, 'S21 Kafka 导出回放样例：使用 classpath Kafka 导出样例对比 v14 与候选版本 v15。', 'admin', '2026-03-12 11:13:00', 'admin', '2026-03-12 11:13:00', b'0');
...
-- ----------------------------
-- Records of policy_def / policy_rule_ref / policy_score_band
-- ----------------------------
DELETE FROM `policy_score_band` WHERE `scene_code` = 'TRADE_RISK' AND `policy_code` IN ('TRADE_RISK_POLICY', 'TRADE_RISK_SCORE_CARD');
DELETE FROM `policy_rule_ref` WHERE `scene_code` = 'TRADE_RISK' AND `policy_code` IN ('TRADE_RISK_POLICY', 'TRADE_RISK_SCORE_CARD');
DELETE FROM `policy_def` WHERE `scene_code` = 'TRADE_RISK' AND `policy_code` IN ('TRADE_RISK_POLICY', 'TRADE_RISK_SCORE_CARD');
...
(3901, 'TRADE_RISK', 'TRADE_RISK_POLICY', '交易风控主策略', 'FIRST_HIT', 'PASS', 'NONE', 0, 1, '当前默认主策略样例（FIRST_HIT）；用于按规则顺序快速收敛 REJECT/REVIEW/PASS。', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
(3902, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', '交易风控评分卡策略', 'SCORE_CARD', 'PASS', 'SUM_HIT_SCORE', 0, 1, '当前并存评分卡样例（SCORE_CARD）；累计命中规则分值后，根据评分段映射最终动作。', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0');
...
(3971, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 'R001', 10, 1, NULL, NULL, 0, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
(3972, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 'R003', 20, 1, NULL, NULL, 0, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
(3973, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 'R002', 30, 1, NULL, NULL, 0, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0');
...
(3951, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 10, 0, 59, 'PASS', '累计分值 {totalScore}，低风险放行', 1, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
(3952, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 20, 60, 119, 'REVIEW', '累计分值 {totalScore}，进入人工复核', 1, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
(3953, 'TRADE_RISK', 'TRADE_RISK_SCORE_CARD', 30, 120, 999999, 'REJECT', '累计分值 {totalScore}，触发拒绝', 1, 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0');
...
(7320, '仿真测试', 'risk:simulation:query', 2, 20, 7300, 'simulation', 'ep:video-play', 'risk/simulation/index', 'RiskSimulation', 0, b'1', b'0', b'1', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
...
(7410, '决策日志', 'risk:decision-log:query', 2, 10, 7400, 'decision-log', 'ep:tickets', 'risk/decision-log/index', 'RiskDecisionLog', 0, b'1', b'0', b'1', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
...
(7420, '接入异常', 'risk:ingest-error:query', 2, 20, 7400, 'ingest-error', 'ep:warning', 'risk/ingest-error/index', 'RiskIngestError', 0, b'1', b'0', b'1', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
...
(7440, '审计日志', 'risk:audit-log:query', 2, 40, 7400, 'audit-log', 'ep:document-checked', 'risk/audit-log/index', 'RiskAuditLog', 0, b'1', b'0', b'1', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
...
(7450, '回放对比', 'risk:replay:query', 2, 50, 7400, 'replay', 'ep:refresh-right', 'risk/replay/index', 'RiskReplay', 0, b'1', b'0', b'1', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0'),
