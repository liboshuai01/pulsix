...
-- ----------------------------
DELETE FROM `scene_release` WHERE `scene_code` = 'TRADE_RISK' AND `version_no` IN (12, 13);
...
(2202, 'TRADE_RISK', 13, '{"snapshotId":"TRADE_RISK_v13","sceneCode":"TRADE_RISK","sceneName":"交易风控","version":13,"status":"VALIDATED","checksum":"3d20b3dc601b9d3e0de7d2ca40488760","runtimeMode":"ASYNC_DECISION","scene":{"defaultPolicyCode":"TRADE_RISK_POLICY","allowedEventTypes":["trade"],"decisionTimeoutMs":500,"logLevel":"FULL"},"eventSchema":{"eventCode":"TRADE_EVENT","eventType":"trade","requiredFields":["eventId","sceneCode","eventType","eventTime","userId","deviceId","ip","amount","result"],"optionalFields":["traceId"]},"variables":{"baseFields":["eventId","sceneCode","eventType","eventTime","traceId","userId","deviceId","ip","amount","result"]},"streamFeatures":[{"code":"user_trade_cnt_5m","type":"STREAM"},{"code":"user_trade_amt_sum_30m","type":"STREAM"},{"code":"device_bind_user_cnt_1h","type":"STREAM"}],"lookupFeatures":[{"code":"device_in_blacklist","type":"LOOKUP","sourceRef":"pulsix:list:black:device"},{"code":"user_risk_level","type":"LOOKUP","sourceRef":"pulsix:profile:user:risk"}],"derivedFeatures":[{"code":"high_amt_flag","type":"DERIVED","dependsOn":["amount"]},{"code":"trade_burst_flag","type":"DERIVED","dependsOn":["user_trade_cnt_5m","amount"]}],"rules":[{"code":"R001","priority":100,"hitAction":"REJECT"},{"code":"R002","priority":90,"hitAction":"REVIEW"},{"code":"R003","priority":80,"hitAction":"REJECT"}],"policy":{"policyCode":"TRADE_RISK_POLICY","decisionMode":"FIRST_HIT","defaultAction":"PASS","ruleOrder":["R001","R003","R002"]},"runtimeHints":{"requiredStreamFeatures":["user_trade_cnt_5m","user_trade_amt_sum_30m","device_bind_user_cnt_1h"],"requiredLookupFeatures":["device_in_blacklist","user_risk_level"],"requiredDerivedFeatures":["high_amt_flag","trade_burst_flag"],"maxRuleExecutionCount":100,"allowGroovy":true,"needFullDecisionLog":true}}', '3d20b3dc601b9d3e0de7d2ca40488760', 'DRAFT', 'PASSED', '{"valid":true,"validationStatus":"PASSED","checks":[{"type":"EVENT_SCHEMA","result":"PASS","message":"默认事件 Schema 已就绪"},{"type":"DERIVED_FEATURE","code":"trade_burst_flag","result":"PASS","message":"表达式校验通过"},{"type":"RULE","code":"R001","result":"PASS","message":"规则表达式校验通过"},{"type":"POLICY","result":"PASS","message":"默认策略已加载"},{"type":"SNAPSHOT","result":"PASS","message":"运行时快照编译通过"}],"warnings":[],"summary":{"passCount":5,"failCount":0,"warningCount":0}}', '{"sceneCode":"TRADE_RISK","defaultEventCode":"TRADE_EVENT","defaultPolicyCode":"TRADE_RISK_POLICY","counts":{"eventFieldCount":10,"streamFeatureCount":3,"lookupFeatureCount":2,"derivedFeatureCount":2,"ruleCount":3,"policyRuleRefCount":3},"lookupFeatures":[{"featureCode":"device_in_blacklist","sourceRef":"pulsix:list:black:device","linkedListCode":"DEVICE_BLACKLIST"},{"featureCode":"user_risk_level","sourceRef":"pulsix:profile:user:risk"}],"rules":[{"ruleCode":"R001"},{"ruleCode":"R002"},{"ruleCode":"R003"}]}', 48, 7, 3, 1, NULL, NULL, NULL, NULL, 'S13 候选版本样例：用于演示预检、依赖摘要和快照预览。', 'admin', '2026-03-12 00:00:00', 'admin', '2026-03-12 00:00:00', b'0');
