...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.liboshuai.pulsix";
    private static final String ARTIFACT_ID = "pulsix";
    private static final String PACKAGE_NAME = "cn.liboshuai.pulsix";
    private static final String TITLE = "脉流实时风控系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.liboshuai.pulsix";
        String artifactIdNew = "pulsix";
        String packageNameNew = "cn.liboshuai.pulsix";
        String titleNew = "脉流实时风控系统";
        String projectBaseDirNew = "C:\\Users\\lbs\\me\\project\\mine\\pulsix"; // 一键改名后，“新”项目所在的目录
