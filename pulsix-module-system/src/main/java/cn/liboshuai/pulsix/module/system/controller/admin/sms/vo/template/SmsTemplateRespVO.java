package cn.liboshuai.pulsix.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "pulsix")
    @ExcelProperty("模板名称")
    private String name;
