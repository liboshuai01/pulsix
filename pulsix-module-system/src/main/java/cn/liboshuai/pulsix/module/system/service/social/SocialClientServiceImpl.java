package cn.liboshuai.pulsix.module.system.service.social;
...
import cn.liboshuai.pulsix.framework.common.util.cache.CacheUtils;
import cn.liboshuai.pulsix.framework.common.util.http.HttpUtils;
import cn.liboshuai.pulsix.framework.common.util.object.BeanUtils;
import cn.liboshuai.pulsix.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.liboshuai.pulsix.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.liboshuai.pulsix.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.liboshuai.pulsix.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.liboshuai.pulsix.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.liboshuai.pulsix.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.liboshuai.pulsix.module.system.dal.dataobject.social.SocialClientDO;
import cn.liboshuai.pulsix.module.system.dal.mysql.social.SocialClientMapper;
import cn.liboshuai.pulsix.module.system.dal.redis.RedisKeyConstants;
import cn.liboshuai.pulsix.module.system.enums.social.SocialTypeEnum;
import cn.liboshuai.pulsix.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.liboshuai.pulsix.framework.common.util.collection.MapUtils.findAndThen;
import static cn.liboshuai.pulsix.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.liboshuai.pulsix.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.liboshuai.pulsix.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${pulsix.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${pulsix.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/pulsix-cloud/pulls/230
