package cn.liboshuai.pulsix.module.infra.controller.admin.job.vo.job;
...
import cn.liboshuai.pulsix.module.infra.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "pulsix")
