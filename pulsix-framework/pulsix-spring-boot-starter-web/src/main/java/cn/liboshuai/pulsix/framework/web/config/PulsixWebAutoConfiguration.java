package cn.liboshuai.pulsix.framework.web.config;
...
import cn.liboshuai.pulsix.framework.web.core.filter.CacheRequestBodyFilter;
import cn.liboshuai.pulsix.framework.web.core.filter.DemoFilter;
import cn.liboshuai.pulsix.framework.web.core.handler.GlobalExceptionHandler;
import cn.liboshuai.pulsix.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PulsixWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "pulsix.demo", havingValue = "true")
