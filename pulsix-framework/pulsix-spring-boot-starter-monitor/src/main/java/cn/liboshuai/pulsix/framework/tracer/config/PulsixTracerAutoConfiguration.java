package cn.liboshuai.pulsix.framework.tracer.config;

import cn.liboshuai.pulsix.framework.common.enums.WebFilterOrderEnum;
import cn.liboshuai.pulsix.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "pulsix.tracer", value = "enable", matchIfMissing = true)
public class PulsixTracerAutoConfiguration {
