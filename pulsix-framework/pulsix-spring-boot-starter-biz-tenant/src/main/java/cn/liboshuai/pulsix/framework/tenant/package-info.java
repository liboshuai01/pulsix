 ...
 *      1）Spring Async：
 *          {@link cn.liboshuai.pulsix.framework.quartz.config.PulsixAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 PulsixSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.liboshuai.pulsix.framework.tenant;
