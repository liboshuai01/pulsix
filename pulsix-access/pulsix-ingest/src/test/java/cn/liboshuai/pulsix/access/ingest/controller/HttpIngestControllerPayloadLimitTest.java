...
@WebMvcTest(value = HttpIngestController.class, properties = "pulsix.access.ingest.http.max-payload-bytes=16")
class HttpIngestControllerPayloadLimitTest {
    ...
    void shouldRejectWhenPayloadTooLarge() throws Exception {
        mockMvc.perform(post("/api/access/ingest/events")
                        ...
                        .content("{\"event_id\":\"E_HTTP_PAYLOAD_TOO_LARGE\"}"))
